...
/**
 * @name Grafo
 * @description Clase de la estructura de datos Grafo
 * @group: GMCarlos_8
...
public class Grafo {
    ...
    public boolean [][] warshallC = new boolean[MAXVERT][MAXVERT];    
    ...
    * @return No retorna ningun valor
    */
    public void adyacente(int origen, Set<Integer> ady){
    ...
    ////////////////////////////////////////////////////////////////////////////////////////Metodos anadidos
      /**
      /**
       * Metodo que llama al metodo profundizar, y hace el recorrido en profundidad del grafo
       * 
       * @param G es un grafo
       * @param vertice es un entero
       * @param visitados es un conjunto de enteros
       */
      /**
    public void profundidad(Grafo G,int vertice,Set<Integer> visitados){
    	  System.out.println("");
    	  visitados= new LinkedHashSet<Integer>();
    	  profundizar(G,vertice,visitados);
      }
    
    /**
     * Metodo que hace el recorrido en profundidad del grafo
     * 
     * @param G es un grafo
     * @param vertice es un entero
     * @param visitados Es un conjunto de enteros
     ...
     */
      /**
      public void profundizar(Grafo G,int vertice,Set<Integer> visitados){
    	  ...
    	  for(Integer w : ady){
    		  if(!visitados.contains(w)){
    			  profundizar(G,w,visitados);
    		  }
    	  }  
      }
      
      /**
       * Metodo que hace el recorrido del grafo en anchura
       * 
       * @param G es un grafo
       * @param vertice es un entero
       * @param visitados es un conjunto de enteros
       */
/**
      public void anchura(Grafo G,int vertice,Set<Integer> visitados){
    	  System.out.println("");
    	  Set<Integer> ady;
   ...
   */   
      /**
       * Metodo que hace el camino minimo entre dos nodos dado por parametro
       * 
       * @param vOrigen en un entero
       * @param vDestino es un entero
       * 
       */
  /**
      public void caminominimo(int vOrigen,int vDestino){
    	  System.out.println("");
    	   
    	  if(warshallC[vOrigen][vDestino]){
    	      int aux=vOrigen;
    	  
    	      System.out.print(vOrigen);
    	      while(aux!=vDestino){
    		     System.out.print(siguiente(aux,vDestino));
    		     aux=siguiente(aux,vDestino);
    	      }
    	  }else
    ...
    */
	...
	public static void main(String[] args) {
	      ...
	      //Datos ejemplo para creaci�n grafo
		Grafo g = new Grafo();
	   ...
	   // ------------------------------------------------------------------------------
 	   // Probando la funci�n adyacentes:
	   int nodo = nodos[8];
	   Set<Integer> ady = new LinkedHashSet<Integer>();
	   System.out.print("Nodos adyacentes al nodo : " + nodo + ":");
	   g.adyacente(nodo,ady);
	   for (Integer n : ady){
		      System.out.print (" " + n);
	   }
	   // ------------------------------------------------------------------------------
